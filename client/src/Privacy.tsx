export default function Privacy() {
    return (
        <section className='relative flex h-fit w-full px-5 pb-20'>
            <div className="mx-auto mt-16 bg-blue-950 text-gray-200 mb-auto font-rale rounded-3xl p-7 flex flex-col justify-around shadow-2xl shadow-black w-150 gap-7 py-11">
