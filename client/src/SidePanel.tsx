...
export default function SidePanel(data: AverageProps) {
    ...
    return (
    <>
            <section className="flex flex-col p-5 sm:p-6 rounded-3xl bg-blue-950 gap-2 h-fit my-auto shadow-2xl shadow-blue-950 text-slate-50 w-fit z-20">
                <h4 className="text-base sm:text-xl">Last Months Averages</h4>
                <hr className="bg-green-500 text-green-500"/>
                <div className="flex gap-4 text-base leading-6 sm:leading-7">
                    <div className="">
                        <p>Duration:</p>
                        <p>Decade:</p>
                        <p>Tempo:</p>
